      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErros?.phone && <p className="text-xs mt-2 rounded-md bg-red-100 text-red-700">{formErros.phone}</p>}
          </div>
        </div>
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center relative">
          ...
          <div className="grow">
            <input type="text" className="input w-full" name="address" 
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[4px] top-[5px] z-50 md:right-[4px] md:top-[5px]">
        ...
        <div>
          ...
          <Button disabled={isSubmitting||isLoadingAddress} type="primary">
            {isSubmitting ? "Placing order...." : `Order now for ${formatCurrency(totaPrice)}`}
          </Button>
        </div>
      </Form>
    </div>
